<?php
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT * FROM categoria WHERE nombre_Categoria LIKE '%$busqueda%' OR descripcion_Categoria LIKE '%$busqueda%' ORDER BY nombre_Categoria ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(id_Categoria) FROM categoria WHERE nombre_Categoria LIKE '%$busqueda%' OR descripcion_Categoria LIKE '%$busqueda%'";

	}else{

		$consulta_datos="SELECT * FROM categoria ORDER BY nombre_Categoria ASC LIMIT $inicio,$registros";
